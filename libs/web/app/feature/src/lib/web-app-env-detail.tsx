import { useWebApp, WebTransactionProvider } from '@kinny/kinetic-web/app/data-access'
import { WebAppUiTabs } from '@kinny/kinetic-web/app/ui'
import { WebKeypairProvider } from '@kinny/kinetic-web/keypair/data-access'
