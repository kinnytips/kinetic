...
import { WebAdminUiAppUpdateForm } from '@kinny/kinetic-web/admin/ui'
import { AdminAppUpdateInput, App, useAdminUpdateAppMutation } from '@kinny/kinetic-web/util/sdk'
