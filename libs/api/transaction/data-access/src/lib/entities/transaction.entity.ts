...
export class Transaction {
  ...
  @ApiProperty({ nullable: true, required: false, default: false, description: 'Indicates if this is a versioned transaction' })
  ...
  @ApiProperty({ nullable: true, required: false })
  @Field(() => GraphQLJSON, { nullable: true, description: 'Address lookup tables used in versioned transactions' })
